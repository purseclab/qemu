...
proj = angr.Project('/home/arslan/sgxsdk3/sgxsdk/SampleCode/SampleEnclave/a.out')
...
#args = [ptr_val, val2]
cs  = proj.factory.call_state(cfg.kb.functions["_Z16ecall_type_floatf"].addr, floatarg)
